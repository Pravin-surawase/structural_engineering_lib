...
| [useBatchDesign.ts](useBatchDesign.ts) | BatchProgress, BatchResult, BatchStatus, BatchDesignState, useBatchDesign | 177 |
| [useBeamGeometry.ts](useBeamGeometry.ts) | Point3D, RebarSegment, RebarPath, StirrupLoop, Beam3DGeometry (+2) | 161 |
| [useCSVImport.ts](useCSVImport.ts) | ImportedBeam, BeamDesignPayload, DesignedBeam, useCSVFileImport, useCSVTextImport (+2) | 442 |
...
| [useTorsionDesign.ts](useTorsionDesign.ts) | useTorsionDesign | 17 |
