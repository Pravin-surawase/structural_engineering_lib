...
export const optimizationResponse = {
  ...
  optimal: {
    ...
    ast_required: 720,
    utilization: 0.82,
    shear_utilization: 0.31,
    stirrup_utilization: 0.72,
    shear_stress: 0.8,
    concrete_shear_strength: 0.62,
    maximum_shear_stress: 3.1,
    stirrup_spacing: 225,
    shear_reinforcement_area: 100.53,
    steel_weight: 5.65,
    steel_weight_total: 28.25,
    is_safe: true,
    code_edition: 'IS 456:2000',
    clause_refs: { 'flexure.Ast': 'IS 456 Cl 38.1', 'shear.tau_v': 'IS 456 Cl 40.1' },
    quantity_basis: 'Required longitudinal reinforcement; stirrup mass excluded.',
  },
  alternatives: [],
};
