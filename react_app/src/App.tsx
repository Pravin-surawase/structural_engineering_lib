...
import { CATALOGUE_QUICK_ENABLED } from './features/catalog/config';
import { LegacyRouteRedirect, ProjectStageRoute } from './app/RouteGuards';
            ...
            <main id="main-content" className="flex-1 overflow-hidden">
              <Suspense fallback={<RouteLoadingFallback />}>
                <Routes>
                  ...
                  <Route path="/start" element={<LegacyRouteRedirect legacyPath="/start" />} />
                  ...
                  <Route path="/workbench/projects/:projectId/review" element={<ProjectStageRoute stage="review"><BuildingEditorPage /></ProjectStageRoute>} />
                  <Route path="/workbench/projects/:projectId/design" element={<ProjectStageRoute stage="design"><BuildingEditorPage /></ProjectStageRoute>} />
                  <Route path="/workbench/projects/:projectId/results" element={<ProjectStageRoute stage="results"><DashboardPage /></ProjectStageRoute>} />
                  <Route path="/design" element={<LegacyRouteRedirect legacyPath="/design" />} />
                  <Route path="/design/results" element={<LegacyRouteRedirect legacyPath="/design/results" />} />
                  <Route path="/import" element={<LegacyRouteRedirect legacyPath="/import" />} />
                  <Route path="/editor" element={<LegacyRouteRedirect legacyPath="/editor" />} />
                  <Route path="/dashboard" element={<LegacyRouteRedirect legacyPath="/dashboard" />} />
                  <Route path="/batch" element={<LegacyRouteRedirect legacyPath="/batch" />} />
