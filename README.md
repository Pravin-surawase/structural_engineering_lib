...
The Python library exposes 37 public functions through `structural_lib.api`. The FastAPI backend provides 60 REST/WebSocket/SSE endpoints across 13 routers.
