...
$manifest = [ordered]@{
    ...
    force_profile = 'wp10-bulk-static-frame-capture/v1; exact assignment table export, source geometry, per-object matrices and completed ordinary static forces; no model mutations'
    ...
    snapshot_transport = 'structural.analysis_snapshot_gzip/v1; canonical v1 payload; bounded expansion and single-member CRC32/ISIZE validation'
