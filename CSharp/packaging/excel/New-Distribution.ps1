...
$manifest = [ordered]@{
    ...
    force_profile = 'wp10-bulk-static-frame-capture/v1; exact requested-object force calls with caller row admission; shared assignment tables and geometry; no model mutations'
