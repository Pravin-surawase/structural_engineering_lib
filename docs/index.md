...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 2204 |
...
| [verification/](verification/) | 173 | Benchmark examples and verification packs for validating library calculations ag |
