...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 8522 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 724 |
...
| [verification/](verification/) | 106 | Benchmark examples and verification packs for validating library calculations ag |
