...
| [SESSION_LOG.md](SESSION_LOG.md) |  | > Append-only decision log for AI agent sessions. > Earlier  | 2623 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 676 |
...
| [verification/](verification/) | 16 | Benchmark examples and verification packs for validating library calculations ag |
