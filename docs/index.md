...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 7569 |
...
| [verification/](verification/) | 81 | Benchmark examples and verification packs for validating library calculations ag |
