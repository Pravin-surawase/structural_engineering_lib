...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | Append-only record of decisions, PRs, and next actions. For  | 10330 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 158 |
| [WORKLOG.md](WORKLOG.md) | Work Log | > **One line per item. Compact. Append-only.** > Format: DAT | 76 |
...
| [architecture/](architecture/) | 14 | Deep dives into project structure, design decisions, and system architecture. |
| [audit/](audit/) | 8 |  |
