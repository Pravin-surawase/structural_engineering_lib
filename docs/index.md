...
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 667 |
| [WORKLOG.md](WORKLOG.md) |  | > **One line per item. Compact. Append-only.** > Format: DAT | 345 |
