...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 8673 |
...
| [verification/](verification/) | 109 | Benchmark examples and verification packs for validating library calculations ag |
