...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 10041 |
...
| [verification/](verification/) | 143 | Benchmark examples and verification packs for validating library calculations ag |
