...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 1697 |
...
| [verification/](verification/) | 168 | Benchmark examples and verification packs for validating library calculations ag |
