...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 9686 |
...
| [verification/](verification/) | 134 | Benchmark examples and verification packs for validating library calculations ag |
