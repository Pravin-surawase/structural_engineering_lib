...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 7493 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 715 |
...
| [verification/](verification/) | 78 | Benchmark examples and verification packs for validating library calculations ag |
