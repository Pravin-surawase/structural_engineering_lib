...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 9813 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 740 |
...
| [verification/](verification/) | 135 | Benchmark examples and verification packs for validating library calculations ag |
