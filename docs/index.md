...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 7102 |
...
| [verification/](verification/) | 66 | Benchmark examples and verification packs for validating library calculations ag |
