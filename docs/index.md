...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 10035 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 744 |
...
| [verification/](verification/) | 141 | Benchmark examples and verification packs for validating library calculations ag |
