...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 6953 |
...
| [verification/](verification/) | 60 | Benchmark examples and verification packs for validating library calculations ag |
