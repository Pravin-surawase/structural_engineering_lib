...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 5822 |
...
| [verification/](verification/) | 31 | Benchmark examples and verification packs for validating library calculations ag |
