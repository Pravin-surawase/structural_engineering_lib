...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 8501 |
...
| [verification/](verification/) | 105 | Benchmark examples and verification packs for validating library calculations ag |
