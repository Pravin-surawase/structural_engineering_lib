...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 9683 |
...
| [verification/](verification/) | 132 | Benchmark examples and verification packs for validating library calculations ag |
