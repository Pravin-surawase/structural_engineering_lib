...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 1430 |
...
| [verification/](verification/) | 164 | Benchmark examples and verification packs for validating library calculations ag |
