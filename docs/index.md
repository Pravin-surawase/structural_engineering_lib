...
| [SESSION_LOG.md](SESSION_LOG.md) | Session Log | > Append-only decision log for AI agent sessions. > Earlier  | 6690 |
| [TASKS.md](TASKS.md) | Task Board | > **Single source of truth for active work.** Keep it short  | 704 |
...
| [verification/](verification/) | 48 | Benchmark examples and verification packs for validating library calculations ag |
