...
| ETABS-W3E-ROOT-CAUSE-FIXES | Correct traced reinforcement defects and preserve material/cover source meaning through real consumers | Main Agent / sole Windows writer | accepted #935; offline software | P1 | FOCUSED VERIFIED: 716 Python, 101 FastAPI and 52 Node checks; configured types and architecture pass. Quick/hooks/hosted integration required. See `docs/planning/etabs-w3-reinforcement-root-causes.md`. Serviceability, torsion detailing and actual-building H remain held. |
