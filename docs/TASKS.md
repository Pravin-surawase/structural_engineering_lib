...
| ETABS-W3-MASTER-PLAN-AUDIT | Freeze the dependency-ordered W3 data, audit, surrogate, optimization, ETABS-reanalysis, Excel and professional-evidence programme plus the guarded next-machine handoff | Main Agent | one Mac planning/audit packet | P1 | 🟡 PLAN PREPARED FOR ACCEPTANCE — live-fetched predecessor is PR #899 merge `7af545ec0e239bac8fa6d480ecbb2b05a60aa40d`, tree `cc40650b7f6569227c880d61a9967ee3bbdfab31`; no W3 runtime or installed application work started |
| ETABS-EXCEL-BEAM-W3A-DEMAND-CONTRACT | Freeze versioned availability, load-pattern/case/combination, analysis-status/result-selection, same-row beam-action, scenario, envelope, governing-reference, paging and canonical-hash contracts before design expansion | Main Agent | 8-15 focused Mac engineer-days; installed getter evidence separate | P1 | ⏸ AWAITING PLAN ACCEPTANCE — exact predecessor PR #899 merge `7af545ec...`, tree `cc40650b...`; no ETABS/Excel, COM adapter, analysis/design, optimization, solver or professional claim in W3A |
| ETABS-EXCEL-BEAM-W3B-INSTALLED-GETTER-SIGNATURES | Audit the accepted W3A getter candidates against installed ETABS 23.3.1 assembly/type-library/generated-wrapper identities without creating COM or opening ETABS/Excel | bounded Windows evidence owner | 2-4 focused days after accepted/merged W3A | P1 | ⏸ HELD — requires accepted plan, exact accepted W3A merge/tree/contract digest, and separate user authorization; copy/paste handoff is prepared but not dispatched |
| ETABS-W3-PARETO-SHEAR-REPAIR | Repair the public Pareto optimizer so nonzero shear participates in feasibility/utilization and unknown objectives fail closed | Main Agent | 2-5 focused Mac days; separate candidate from W3A | P1 | ⏸ HELD AS SEPARATE REPAIR — confirmed current path accepts `vu_kn` but marks flexure-only candidates safe; blocks Pareto use for ETABS candidate selection, not W3A contract work |
