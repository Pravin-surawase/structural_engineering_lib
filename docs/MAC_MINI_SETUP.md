...
- [agent-bootstrap.md](getting-started/agent-bootstrap.md) — AI agent onboarding (60-second version)
- [python-quickstart.md](getting-started/python-quickstart.md) — Python library usage examples
- [TASKS.md](TASKS.md) — Current task board and priorities
- [next-session-brief.md](planning/next-session-brief.md) — Latest handoff notes
