...
- [ ] Add `Python/structural_lib/serviceability.py`
- [ ] Add result types to `Python/structural_lib/types.py`:
  - `DeflectionResult`
  - `CrackWidthResult`
...
- [ ] Add a new module (suggested): `VBA/Modules/M17_Serviceability.bas`
- [ ] Add UDTs mirroring Python (names can differ, fields should map cleanly).
