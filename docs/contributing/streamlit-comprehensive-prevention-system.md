...
- repo: local
  hooks:
    - id: check-streamlit-issues
      ...
      entry: .venv/bin/python scripts/check_streamlit.py --all-pages --fail-on critical,high
      language: python
...
## 🔗 Related Documents
- [Cost Optimizer Prevention System](../../scripts/_archive/check_cost_optimizer_issues.py) - Original system
