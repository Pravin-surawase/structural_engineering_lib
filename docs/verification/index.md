...
- [india-2-flat-acceptance-git-handoff-receipt.json](india-2-flat-acceptance-git-handoff-receipt.json)
- [india-2-flat-acceptance-git-handoff-source-evidence.json](india-2-flat-acceptance-git-handoff-source-evidence.json)
- [india-2-flat-b-git-handoff-receipt.json](india-2-flat-b-git-handoff-receipt.json)
- [india-2-flat-b-git-handoff-source-evidence.json](india-2-flat-b-git-handoff-source-evidence.json)
- [india-2-flat-c-git-handoff-receipt.json](india-2-flat-c-git-handoff-receipt.json)
- [india-2-flat-c-git-handoff-source-evidence.json](india-2-flat-c-git-handoff-source-evidence.json)
- [india-2-flat-d-git-handoff-receipt.json](india-2-flat-d-git-handoff-receipt.json)
- [india-2-flat-d-git-handoff-source-evidence.json](india-2-flat-d-git-handoff-source-evidence.json)
- [india-2-flat-e-git-handoff-receipt.json](india-2-flat-e-git-handoff-receipt.json)
- [india-2-flat-e-git-handoff-source-evidence.json](india-2-flat-e-git-handoff-source-evidence.json)
...
- [india-2-foundation-combined-a-git-handoff-receipt.json](india-2-foundation-combined-a-git-handoff-receipt.json)
- [india-2-foundation-combined-a-git-handoff-source-evidence.json](india-2-foundation-combined-a-git-handoff-source-evidence.json)
- [india-2-foundation-combined-acceptance-git-handoff-receipt.json](india-2-foundation-combined-acceptance-git-handoff-receipt.json)
- [india-2-foundation-combined-acceptance-git-handoff-source-evidence.json](india-2-foundation-combined-acceptance-git-handoff-source-evidence.json)
- [india-2-foundation-combined-acceptance-nonfrozen-replay.json](india-2-foundation-combined-acceptance-nonfrozen-replay.json)
- [india-2-foundation-combined-b-git-handoff-receipt.json](india-2-foundation-combined-b-git-handoff-receipt.json)
- [india-2-foundation-combined-b-git-handoff-source-evidence.json](india-2-foundation-combined-b-git-handoff-source-evidence.json)
- [india-2-foundation-combined-c-git-handoff-receipt.json](india-2-foundation-combined-c-git-handoff-receipt.json)
- [india-2-foundation-combined-c-git-handoff-source-evidence.json](india-2-foundation-combined-c-git-handoff-source-evidence.json)
- [india-2-foundation-combined-d-git-handoff-receipt.json](india-2-foundation-combined-d-git-handoff-receipt.json)
...
- [india-2-foundation-pile-cap-g0-git-handoff-receipt.json](india-2-foundation-pile-cap-g0-git-handoff-receipt.json)
- [india-2-foundation-pile-cap-g0-git-handoff-source-evidence.json](india-2-foundation-pile-cap-g0-git-handoff-source-evidence.json)
- [india-2-foundation-raft-g0-git-handoff-receipt.json](india-2-foundation-raft-g0-git-handoff-receipt.json)
- [india-2-foundation-raft-g0-git-handoff-source-evidence.json](india-2-foundation-raft-g0-git-handoff-source-evidence.json)
...
- [india-2-foundation-strap-d-git-handoff-receipt.json](india-2-foundation-strap-d-git-handoff-receipt.json)
...
- [india-2-truth-hygiene-38-2-git-handoff-receipt.json](india-2-truth-hygiene-38-2-git-handoff-receipt.json)
- [india-2-truth-hygiene-38-2-git-handoff-source-evidence.json](india-2-truth-hygiene-38-2-git-handoff-source-evidence.json)
...
- [lib-pro-002-i-git-handoff-receipt.json](lib-pro-002-i-git-handoff-receipt.json)
- [lib-pro-002-j-closeout-determinism-git-handoff-receipt.json](lib-pro-002-j-closeout-determinism-git-handoff-receipt.json)
...
| [a2-lossless-intake-calculation-evidence.md](a2-lossless-intake-calculation-evidence.md) |  | This record does not authorize gravity orchestration, live E | 141 |
...
| [e1-blank-workbook-guard-evidence.md](e1-blank-workbook-guard-evidence.md) |  | - repair branch: codex/e1-blank-workbook-guard; - stacked ba | 98 |
...
| [e1-windows-w0-setup-evidence.md](e1-windows-w0-setup-evidence.md) |  | SETUP_BLOCKED — the Windows host/catalog setup now passes, b | 135 |
...
| [india-2-flat-d-punching-evidence.md](india-2-flat-d-punching-evidence.md) |  | FLAT-D adds the centred concentric punching check for the G0 | 82 |
| [india-2-flat-e-publication-evidence.md](india-2-flat-e-publication-evidence.md) |  | FLAT-E composes the integrated FLAT-A-D calculations into th | 93 |
| [india-2-flat-family-acceptance-evidence.md](india-2-flat-family-acceptance-evidence.md) |  | exact integrated G0/A-E starting head was b04d80653484a8dc43 | 100 |
...
| [india-2-foundation-raft-g0-hold-evidence.md](india-2-foundation-raft-g0-hold-evidence.md) |  | implementation files. The frozen candidate remains one regul | 187 |
