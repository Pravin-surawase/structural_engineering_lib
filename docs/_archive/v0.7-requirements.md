# v0.7.0 Requirements — Detailing & Drawings

**Status:** ✅ Approved by CLIENT Agent
**Date:** 2025-12-11
**Version Target:** v0.7.0

---

## 1. CLIENT Agent — Requirements Specification

### 1.1 Output Format Decision
| Option | Decision |
|--------|----------|
| **DXF (AutoCAD compatible)** | ✅ **SELECTED** |
| SVG (web/PDF) | ❌ Not needed |
| ASCII/Text diagram | ❌ Too basic |
| Excel-embedded shapes | ❌ Not portable |
...
|---------|----------|-------|
| **Beam Elevation** | ✅ YES | Longitudinal view with dimensions |
| **Reinforcement Layout** | ✅ YES | Main bars (top/bottom), stirrups |
| Section cuts (cross-sections) | ⚠️ Optional | Nice to have for v0.7 |
| Bar Bending Schedule (BBS) | ❌ v0.8+ | Separate deliverable |

### 1.3 Level of Detail
| Level | Decision |
|-------|----------|
| Schematic (conceptual) | ❌ |
| **Shop Drawing (fabrication-ready)** | ✅ **SELECTED** |
...
4. Reinforcement callouts are readable (e.g., "3-16φ").
...
| Role | Status | Date |
|------|--------|------|
| CLIENT | ✅ Approved | 2025-12-11 |
| PM | ✅ Scope Locked | 2025-12-11 |
