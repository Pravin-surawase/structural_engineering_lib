...
### Prototype + Research Inputs

- Prototype findings: `docs/planning/prototype-findings-intelligence.md`
  (validated on 3 sample vectors; not a general accuracy claim).
- Research review: `docs/planning/research-smart-library.md`
  (optimization research retained, but v0.14 uses deterministic alternatives).
