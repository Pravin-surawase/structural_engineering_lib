...
| 2026-08-29 | ETABS-EXCEL-BEAM-W2B-TRANSPORT | Added the real file observer, serialized preflight-bound COM orchestration, bounded REST contract, exact seven-table Excel projection/reconciliation, and abort-before-force repair with focused fake-COM/API/Office tests | pending Phase B candidate |
