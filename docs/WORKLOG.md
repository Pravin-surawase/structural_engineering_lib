...
| 2026-04-07 | Audit | Fix 2 stale deprecated import paths (geometry_3d docstring, test_visualization_integration) | — |
| 2026-04-07 | Audit | Batch 3 detailed planning: API naming convention + public surface audit | — |
...
| 2026-04-07 | v0.21.6 | Version sync: 10 stale 0.21.5 refs fixed across fastapi, react, docs | — |
| 2026-04-07 | v0.21.6 | bump_version.py: added 4 missing files (fastapi __init__, config, openapi baseline, SettingsPanel) | — |
| 2026-04-07 | v0.21.6 | Release preflight passed: 5143 tests, 69 golden, 18 contract, packaging OK, security OK | — |
| 2026-04-07 | v0.21.6 | Agent evolution check: version drift 5th occurrence, bump_version.py fix applied | — |
...
| 2026-04-06 | v0.21.5 verify | Multi-agent review, React localStorage fix, CostProfile __init__ export | 2c5da3ce |
...
| 2026-04-06 | Architecture | Enhanced unified-architecture-v1.md (413→1108 lines, 8 new sections, 9-agent review) | pending-commit |
...
| 2026-08-29 | ETABS-EXCEL-BEAM-W2A-BASELINE | Added the transport-neutral read-only model/topology/result contract, deterministic provenance, exhaustive dispositions, fake-COM tests, and Windows runtime portability repairs; retained W2B/W2C and engineering holds | 0f5c918e |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2A-MACHINE-HANDOFF | Designated Mac as primary development/integration and Windows as installed Excel/ETABS evidence; documented the exact setup/root-cause/remaining-work ledger and repaired Windows source-path onboarding | 0f5c918e |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2A-MAC-REPAIR | Reproduced and repaired accepted unknown-story topology by binding every frame story to the exact story inventory; preserved `HELD_NOT_SUPPORTED` and every W2 boundary | 0f5c918e |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2C-COM-SIGNATURE-AUDIT | Bound all 18 W2A getters plus the sole unit setter to exact installed ETABS 23.3.1 type-library/generated-wrapper metadata and froze W2C preflight/abort evidence without COM object creation | 4841ab2a |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2B-TRANSPORT | Added the real file observer, serialized preflight-bound COM orchestration, bounded REST contract, exact seven-table Excel projection/reconciliation, and abort-before-force repair with focused fake-COM/API/Office tests | 395f0618 |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2C-INSTALLED-HOLD | Repaired CSI's installed `GetStories` Base-row shape, then proved direct/REST/installed Excel all fail closed before force reads when the exact approved combination is inactive; retained unchanged model/workbook/unit/lock evidence and the retry hold | 5a41aee6 |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2-MAC-INTEGRATION | Independently reviewed the exact cumulative Windows campaign with no essential finding and repaired the date-sensitive compatibility-ledger lossless test without regenerating a semantically current ledger; PR #897 merged the reviewed candidate unchanged | ee50aaa3 |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2C-INSTALLED-RETRY | Repeated the installed getter-only preflight after owner confirmation, then stopped before request/force/REST/Excel when the exact approved combination still read inactive; preserved unchanged model/workbook evidence and the W2C hold | — |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2C-INSTALLED-ACCEPTANCE | After the separately authorized exact selection prerequisite, reconciled accepted direct/REST baseline `d4c28586...` and repaired only volatile observation-time hash drift; installed Excel wrote six exact tables but failed at JSON `Range.values` on `+`/`-`-prefixed chunks, so preserved model state and froze `BLOCKED_SAFE_EXCEL_JSON_WRITE` without a second repair | c999b6f5 |
| 2026-08-29 | ETABS-EXCEL-BEAM-W2C-TRANSACTIONAL-ACCEPTANCE | Added typed literal JSON cells and rollback-safe seven-table transactions, normalized Excel blank/15-digit readback, then reconciled direct/REST/all saved Excel tables and exact canonical JSON while preserving the copied model; PR #898 merged the exact reviewed candidate unchanged | 57f53d48, f1873e7b |
| 2026-08-30 | ETABS-W3-MASTER-PLAN-AUDIT | Verified PR #899 merge/tree as the exact W3-readiness predecessor; froze the public data/demand signatures, evidence ladder, Mac/Windows packet sequence, calibration/surrogate/mandatory-ETABS boundary, separate Pareto shear repair, Excel/professional evidence path, and guarded copy/paste Windows handoff without starting runtime or installed work | planning candidate |
