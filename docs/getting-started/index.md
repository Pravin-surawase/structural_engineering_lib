...
| [agent-bootstrap.md](agent-bootstrap.md) |  | > **This is THE canonical bootstrap for all AI agents.** Ent | 768 |
...
| [colab-workflow.md](colab-workflow.md) |  | This guide runs the full pipeline in Google Colab: install → | 524 |
| [copilot-quick-start.md](copilot-quick-start.md) |  | > **⚠️ CONSOLIDATED:** This document has been simplified. > | 204 |
| [cost-optimization-guide.md](cost-optimization-guide.md) |  | This guide explains how to use the cost optimization feature | 58 |
| [design-suggestions-guide.md](design-suggestions-guide.md) |  | The design suggestions engine provides expert recommendation | 462 |
| [fix-copilot-terminal.md](fix-copilot-terminal.md) |  | Copilot Agent's terminal is stuck in git pager mode. Command | 157 |
...
| [releases.md](releases.md) |  | This document serves as the **immutable source of truth** fo | 1121 |
