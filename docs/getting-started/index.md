...
Quick onboarding guides for new users. | Guide | Audience | Time |
...
| [excel-tutorial.md](excel-tutorial.md) | This tutorial walks you through using the Structural Engineering Library in Exce | 2026-01-10 | 383 |
| [fix-copilot-terminal.md](fix-copilot-terminal.md) | Copilot Agent's terminal is stuck in git pager mode. Commands open "alternate bu | 2026-01-10 | 138 |
| [insights-guide.md](insights-guide.md) | > **Status:** Preview (v0.13.0+) > **Stability:** Experimental - API may change  | 2026-01-08 | 528 |
| [python-quickstart.md](python-quickstart.md) | This guide shows how to install, run, and verify the Python library with simple, | 2026-01-07 | 163 |
| [user-guide.md](user-guide.md) | This guide walks you through a complete beam design workflow from start to finis | 2026-01-08 | 208 |
