...
| [agent-bootstrap.md](agent-bootstrap.md) | > **Read this first.** This is the fastest path to productive work. > **👤 For us | 2026-01-13 | 128 |
...
| [cost-optimization-guide.md](cost-optimization-guide.md) | This guide explains how to use the cost optimization features to explore cheaper | 2026-01-13 | 49 |
| [design-suggestions-guide.md](design-suggestions-guide.md) | The design suggestions engine provides expert recommendations to improve your be | 2026-01-13 | 453 |
| [excel-quickstart.md](excel-quickstart.md) | This is the easiest path if you prefer Excel and do not want to code. Use one of | 2026-01-13 | 68 |
| [excel-tutorial.md](excel-tutorial.md) | This tutorial walks you through using the Structural Engineering Library in Exce | 2026-01-15 | 393 |
