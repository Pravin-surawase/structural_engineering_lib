...
- [Agent 8 Mistakes Guide](../planning/agent-8-mistakes-prevention-guide.md#high-terminal-stuck-in-git-pager-alternate-buffer)
...
**Ref:** [Agent 8 Mistakes Guide](../planning/agent-8-mistakes-prevention-guide.md#critical-the-merge-commit-spike-disaster)
...
- **Agent 8 Mistakes Guide:** [agent-8-mistakes-prevention-guide.md](../planning/agent-8-mistakes-prevention-guide.md)
