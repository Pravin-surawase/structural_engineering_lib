...
|------|-------|-------------|-------|
| [README.md](README.md) | Guidelines Index | Development standards and best practices for the structural  | 81 |
| [ai-token-efficiency.md](ai-token-efficiency.md) |  | This is the canonical low-token operating policy for AI-assi | 224 |
...
| [migration-workflow-guide.md](migration-workflow-guide.md) |  | bash .venv/bin/python scripts/pre_migration_check.py | 467 |
| [parallel-task-policy.md](parallel-task-policy.md) |  | This policy allows independent Codex tasks to run at the sam | 156 |
