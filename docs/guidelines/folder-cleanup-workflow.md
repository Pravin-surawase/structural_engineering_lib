...
./scripts/python_runtime.sh scripts/find_orphan_files.py --all --age

# Check folder README coverage
./scripts/python_runtime.sh scripts/check_folder_readmes.py --verbose
...
# Phase 1: Deletions
./scripts/python_runtime.sh scripts/safe_file_delete.py docs/duplicate.md
./scripts/python_runtime.sh scripts/safe_file_delete.py docs/empty.md

# Phase 2: Archives
./scripts/python_runtime.sh scripts/safe_file_move.py docs/old-plan.md docs/_archive/2026-01/old-plan.md

# Phase 3: Reorganization
./scripts/python_runtime.sh scripts/safe_file_move.py docs/misplaced.md docs/correct-folder/misplaced.md
```
...
./scripts/python_runtime.sh scripts/safe_file_delete.py docs/file1.md
./scripts/python_runtime.sh scripts/safe_file_delete.py docs/file2.md
./scripts/python_runtime.sh scripts/check_links.py  # Verify after each batch
git add -- docs
git commit -m "chore: remove duplicate files"

# Batch 2: Archive old planning
./scripts/python_runtime.sh scripts/safe_file_move.py docs/planning/old1.md docs/_archive/planning/old1.md
./scripts/python_runtime.sh scripts/safe_file_move.py docs/planning/old2.md docs/_archive/planning/old2.md
./scripts/python_runtime.sh scripts/check_links.py
git add -- docs
git commit -m "chore: archive old planning docs"

# Batch 3: Reorganize
./scripts/python_runtime.sh scripts/safe_file_move.py docs/misplaced.md docs/correct/misplaced.md
./scripts/python_runtime.sh scripts/check_links.py
git add -- docs
...
./scripts/python_runtime.sh scripts/check_folder_structure.py

# No new orphans created
./scripts/python_runtime.sh scripts/find_orphan_files.py
