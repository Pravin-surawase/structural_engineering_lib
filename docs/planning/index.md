...
| [compact-modernization-plan.md](compact-modernization-plan.md) |  | Modernize the repository's CI, maintenance controls, and age | 789 |
...
| [is456-library-first-master-plan.md](is456-library-first-master-plan.md) |  | The Python package is the product. FastAPI, React, command-l | 1473 |
...
| [next-session-brief.md](next-session-brief.md) | Next Session Briefing | <!-- HANDOFF:START --> - Date: 2026-08-10 | 127 |
| [pre-release-checklist.md](pre-release-checklist.md) | Pre-Release Checklist | Installed metadata version: 0.23.0 - **Branch:** codex/relea | 53 |
| [professional-library-remediation-plan.md](professional-library-remediation-plan.md) | Professional Library Remediation Plan | This document is no longer the active implementation plan. T | 534 |
