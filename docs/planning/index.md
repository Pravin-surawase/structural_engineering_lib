...
| [india-2-next-session-publication-and-closeout-plan.md](india-2-next-session-publication-and-closeout-plan.md) |  | COMBINED-C/D and focused family acceptance are integrated. S | 317 |
...
| [next-session-brief.md](next-session-brief.md) | Next Session Briefing | <!-- HANDOFF:START --> - Date: 2026-08-16 | 131 |
