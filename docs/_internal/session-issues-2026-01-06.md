...
3. **Git workflow documented** - Comprehensive guide in `docs/git-workflow-ai-agents.md`
...
- Documentation: `.github/copilot-instructions.md`, `docs/git-workflow-ai-agents.md`
