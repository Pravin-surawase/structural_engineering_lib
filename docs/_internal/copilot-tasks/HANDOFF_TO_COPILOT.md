...
**Detailed instructions:** See `TASK_0.1_xlwings_installation_COPILOT.md`
...
docs/_internal/copilot-tasks/TASK_0.1_xlwings_installation_COPILOT.md
```
...
```bash
docs/_internal/copilot-tasks/XLWINGS_TEST_RESULTS.md
...
| File | Purpose |
|------|---------|
| `TASK_0.1_xlwings_installation_COPILOT.md` | Your main instruction guide |
| `PROGRESS_TRACKER.md` | Track progress (update as you go) |
| `XLWINGS_QUICK_START.md` | User reference (already created by Claude) |
...
| File | When to Create |
|------|---------------|
| `XLWINGS_TEST_RESULTS.md` | After all UDFs work in Excel |
...
- [ ] Results documented in XLWINGS_TEST_RESULTS.md
...
**Copilot: Start by reading `TASK_0.1_xlwings_installation_COPILOT.md` and follow Step 1.**
