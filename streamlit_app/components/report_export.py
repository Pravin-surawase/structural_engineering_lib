...
- Moment: {result.inputs.mu_knm} kN·m
- Shear: {result.inputs.vu_kn} kN

## Results
- Ast Required: {result.ast_mm2:.0f} mm²
- Ast Provided: {result.ast_provided_mm2:.0f} mm²
...
def show_export_options(
    ...
    if result is None:
        st.info("💡 Complete a design calculation to enable report export.")
        return
...
def show_audit_trail_summary() -> None:
    ...
    # Export audit log
    if st.button("📥 Export Audit Log", key="export_audit_btn"):
