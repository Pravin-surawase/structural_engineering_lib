...
- **Add-in packaging:** See `docs/contributing/excel-addin-guide.md` for bulk import macro and `.xlam` packaging. Set the VBA project name to `StructEngLib` (no spaces), then save as `.xlam`.
