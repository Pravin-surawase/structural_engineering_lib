...
| **VBA Workflow Guide** | Full workflow docs | [vba-vscode-workflow.md](./vba-vscode-workflow.md) |
...
3. **Start Task 1.1** (follow [task-1.1-beamdesignschedule-spec.md](./task-1.1-beamdesignschedule-spec.md))
