...
**📚 Full Catalog:** [automation-catalog.md](agent-9-governance-legacy/AUTOMATION-CATALOG.md)
```
...
```markdown
- **Automation scripts (41):** [reference/automation-catalog.md](agent-9-governance-legacy/AUTOMATION-CATALOG.md) 🤖
```
