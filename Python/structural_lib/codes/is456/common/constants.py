...
# ---------------------------------------------------------------------------
# Steel modulus of elasticity --- IS 456 Cl. 5.6.3
# ---------------------------------------------------------------------------
ES_STEEL_MPA: float = 200_000.0

# ---------------------------------------------------------------------------
# Ultimate concrete strain --- IS 456 Cl. 38.1 (Fig. 21)
# ---------------------------------------------------------------------------
EPSILON_CU: float = 0.0035

# ---------------------------------------------------------------------------
# Strain at peak concrete stress --- IS 456 Cl. 38.1 (Fig. 21)
# ---------------------------------------------------------------------------
EPSILON_C0: float = 0.002

# ---------------------------------------------------------------------------
# Pure axial eccentricity threshold --- IS 456 Cl. 39.3
# Pu formula valid only when e <= 0.05 * D
# ---------------------------------------------------------------------------
COLUMN_AXIAL_EMIN_FACTOR: float = 0.05
