...
def _validate_sample_count(name: str, value: int, minimum: int) -> None:
    """Reject non-integral and undersized numerical sampling controls."""
...
def _validate_section_and_layout(
    *,
    ...
    _validate_sample_count("n_fibers_x", n_fibers_x, _MIN_FIBERS_PER_AXIS)
    _validate_sample_count("n_fibers_y", n_fibers_y, _MIN_FIBERS_PER_AXIS)
    _validate_sample_count("n_depths", n_depths, _MIN_DEPTH_POINTS)
...
def experimental_pmm_interaction_surface(
    *,
    ...
    _validate_sample_count("n_angles", n_angles, _MIN_ANGLES)
