...
class TestCSVParsing:
    ...
    def test_csv_with_missing_optional_fields(self, temp_output_dir):
        ...
        with open(csv_path, 'w', newline='') as f:
            writer = csv.writer(f)
            writer.writerow(["BeamID", "Story", "b", "D", "Span", "fck", "fy", 
                           "Mu", "Vu", "Ast_req", "Stirrup_Dia", "Stirrup_Spacing"])
            writer.writerow(["B1", "Story1", 300, 500, 4000, 25, 500, 
                           150, 100, 942.5, 8, 150])
...
class TestProcessing:
    ...
    def test_process_single_beam_detailing_only(self, sample_beam_data, temp_output_dir):
    ...
    def test_process_single_beam_with_detailing_values(self, sample_beam_data, temp_output_dir):
