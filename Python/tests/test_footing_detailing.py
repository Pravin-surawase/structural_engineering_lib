...
def test_square_benchmark_selects_buildable_12mm_layers():
    ...
    assert result.lower.flexure_result_area_mm2 == pytest.approx(1226.424, rel=1e-4)
    assert result.upper.flexure_result_area_mm2 == pytest.approx(1262.202, rel=1e-4)
    assert result.lower.analysis_screening_area_mm2 == pytest.approx(1369.010)
    assert result.upper.analysis_screening_area_mm2 == pytest.approx(1369.010)
    assert result.lower.minimum_area_mm2 == result.upper.minimum_area_mm2 == 1200
    assert result.lower.required_area_mm2 == pytest.approx(1369.010)
    assert result.upper.required_area_mm2 == pytest.approx(1369.010)
